...
public:
    ...
    virtual Vector3 diffuse2D(const tex_coord2d_t & texcoords) const { return Vector3(0); }
    virtual Vector3 diffuse3D(const tex_coord3d_t & texcoords) const { return Vector3(0); }
